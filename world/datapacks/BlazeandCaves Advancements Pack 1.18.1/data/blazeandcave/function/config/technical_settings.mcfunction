...
# Update Scoreboard
tellraw @s ["",{"text":"[ »» ]","color":"green","clickEvent":{"action":"run_command","value":"/function bacap_rewards:update_score"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Goes through every advancement for every player online, and recounts how many advancements they have","color":"white"},{"text":"\n"},{"translate":"Should be used if:","color":"white"},{"text":"\n"},{"translate":"- You have recently updated to a new datapack version, especially across a new Minecraft update","color":"white"},{"text":"\n"},{"translate":"- You have been using commands to manually revoke the advancements of player(s)","color":"white"},{"text":"\n"},{"translate":"Click to run","color":"gold"}]}}," ",{"translate":"Update scoreboard"}]
# Update Team Scoreboard
tellraw @s ["",{"text":"[ »» ]","color":"aqua","clickEvent":{"action":"run_command","value":"/function bacap_rewards:team_score"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Re-calculates the value of team scoreboards that draw from players' advancement and first advancement scores","color":"white"},{"text":"\n"},{"translate":"Click to run","color":"gold"}]}}," ",{"translate":"Update team scoreboards"}]
...
tellraw @s ["",{"text":"[ »» ]","color":"#FF2A2A","clickEvent":{"action":"run_command","value":"/function blazeandcave:config/hardcore_to_survival"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Revokes all death-related advancements. This function should only be used if you die while playing in Hardcore Mode and using the Hardcore version of this datapack, but want to continue playing anyway as though it is ordinary survival.","color":"white"},{"text":"\n"},{"translate":"Click to run","color":"gold"}]}}," ",{"translate":"Revoke death advancements (Hardcore to survival)"}]
# Revoke all advancements
tellraw @s ["",{"text":"[ »» ]","color":"dark_red","clickEvent":{"action":"run_command","value":"/function blazeandcave:config/revoke_ru_sure"},"hoverEvent":{"action":"show_text","contents":["",{"translate":"Revokes every advancement, including resetting scoreboards","color":"white"},{"text":"\n"},{"translate":"You may choose to revoke from either yourself, the closest player to you, or from everyone currently online","color":"white"},{"text":"\n"},{"translate":"Click to run","color":"gold"}]}}," ",{"translate":"Revoke all advancements"}]
